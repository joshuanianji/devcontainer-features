...
| [token-monitor-agent](./src/token-monitor-agent)             | Report token usage from this container to a self-hosted [token-monitor](https://github.com/Javis603/token-monitor) hub.                           |
